...
Функция ЗарегистрироватьНаСервере()
	...
	Попытка
		...
		Для каждого ДанныеКлиента Из Ответ["loyaltyAccounts"] Цикл
			...
			ДатаСоздания = crm_RetailCRMОбщийВызовСервера.ПреобразоватьДатуCRM(ДанныеКлиента["createdAt"]);
			ДатаАктивацииУчастия = crm_RetailCRMОбщийВызовСервера.ПреобразоватьДатуCRM(ДанныеКлиента["activatedAt"]);
